...
sudo apt update
#Installs QEMU for x86 systems automatically without asking for confirmation.
sudo apt install qemu-system-x86 -y
#Runs a virtual machine in the terminal, boots the kernel “bzImage” with “init.cpio”, and uses the “boot” file as a virtual disk.
